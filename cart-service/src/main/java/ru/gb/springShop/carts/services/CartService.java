...
public class CartService {
    ...
    public void add(Long productId) {
        ProductDto product = productServiceIntegration.getProductById(productId).orElseThrow(() -> new ResourceNotFoundException("Не  удается добавить продукт: " + productId + " в корзину. Продукт не найден"));
