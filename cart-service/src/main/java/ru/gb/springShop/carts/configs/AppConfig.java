...
import ru.gb.springShop.carts.propierties.ProductServiceIntegrationProperties;

import java.util.concurrent.TimeUnit;

/*бин для отправки запросов */
@Configuration

@EnableConfigurationProperties( // разрешаем использовать бин с конфигом
...
public class AppConfig {
    ...
    public WebClient productServiceWebClient() {
        //создаем tcp клиент, настраиваем таймауы
...
//после настройки собираем вебклиент
        return WebClient
                .builder()
