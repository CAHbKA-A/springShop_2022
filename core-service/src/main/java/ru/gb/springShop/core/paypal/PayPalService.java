package ru.gb.springShop.core.paypal;
...
public class PayPalService {
    ...
    public OrderRequest createOrderRequest(Long orderId) {
        ...
        ru.gb.springShop.core.entities.Order order = orderService.findById(orderId).orElseThrow(() -> new ResourceNotFoundException("Order not found"));
